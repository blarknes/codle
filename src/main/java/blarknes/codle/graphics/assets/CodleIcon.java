...
/**
 * Provides the application icon in various formats to be used along the
 * application.
 */
public class CodleIcon {
    ...
    /**
     * Get the application icon as a JavaFX Image.
     *
    ...
    /**
     * Get the application icon as a JavaFX Pane.
     *
     * @return The application icon.
     */
    public Pane asPane() {
